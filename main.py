...
root.config(bg='grey')
label1=Label(root,text='Tic Tac Toe',font="Times 15 bold",bg='cyan',fg='black',bd=4,height=2,width=10,relief=RAISED,)
label1.grid(row=0,column=1,padx=5,pady=5,sticky='nsnew')

label2=Label(root,text=f'SCORE-->PLAYER1: {ScoreX}\n-->PLAYER2: {ScoreO}',font="Times 15 bold",bg='cyan',fg='black',bd=4,height=1,width=10,relief=RAISED,)
label2.grid(row=4,column=0,padx=5,pady=5,sticky='nsnew')

label3=Label(root,text='PLAYER 1',font="Times 15 bold",bg='cyan',fg='black',bd=4,height=2,width=10,relief=RAISED,)
...
b11=Button(root,font="Times 15 bold",text='END',bg='cyan',fg='white',height=2,width=10)
